      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="flex flex-col items-center text-center space-y-8 animate-fade-in">
          ...
          <div className="flex items-center gap-6 mb-4">
            ...
            <img alt="Cristaly" src="/lovable-uploads/e745fd16-6c9b-457e-8d60-d4fdec4038fd.png" className="h-72 md:h-[432px] animate-scale-in opacity-100 object-fill rounded-none shadow-none" />
          </div>
