    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background selection:bg-primary/30">
      ...
      <div className="container relative z-10 px-4 pt-16 md:pt-20 pb-20 md:pb-32">
        <div className="flex flex-col items-center text-center space-y-6 md:space-y-10 animate-fade-in">
          ...
          {/* Feature Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mt-12 md:mt-20 w-full max-w-5xl animate-slide-up" style={{ animationDelay: "0.6s" }}>
            {[
              {
                icon: Bot,
              ...
              <div key={i} className="group p-5 md:p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-primary/50 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm">
