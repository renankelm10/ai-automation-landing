  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-primary/10 rounded-full blur-3xl animate-float"
          style={{
            animationDelay: "4s",
          }}
        />
      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="flex flex-col items-center text-center space-y-8 animate-fade-in">
          ...
          <div className="flex items-center gap-6 mb-4">
            ...
            <img
              alt="Cristaly"
              src="/lovable-uploads/e745fd16-6c9b-457e-8d60-d4fdec4038fd.png"
              className="h-96 md:h-[520px] animate-scale-in opacity-100 object-fill rounded-none shadow-none"
            />
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl">
            Automatize seu atendimento no WhatsApp e redes sociais com inteligência artificial. Responda mais rápido,
            converta mais vendas.
          </p>
